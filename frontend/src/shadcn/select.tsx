...
>(({ className, children, iconColor = '', ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      'focus:outline-none flex h-9 w-full items-center justify-between rounded-md border border-input bg-transparent px-3 py-2 text-sm shadow-background placeholder:text-muted-foreground  disabled:cursor-not-allowed disabled:opacity-50',
      className
    )}
    {...props}
  >
